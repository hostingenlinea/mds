                ...
                <div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
                    <div className="px-6 md:px-8 py-6 border-b border-gray-100 bg-gray-50 flex justify-between items-center">
                        <div>
                            ...
                            <p className="text-sm text-gray-500 mt-1">Datos del pastor.</p>
                        </div>
                    ...
                    <form onSubmit={guardarPastor} className="p-6 md:p-8 space-y-6">
                        ...
                        <div className="flex justify-end gap-3 pt-4">
                            ...
                            <button type="submit" disabled={uploading} className="px-8 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-lg shadow-md transition disabled:opacity-50 w-full md:w-auto">
                                {uploading ? 'Guardando...' : 'Guardar Pastor'}
                            </button>
                        </div>
                    </form>
                </div>
...
const Select = ({ label, val, set, options }) => (
    <div>
      ...
      <div className="relative">
          <select value={val} onChange={e => set(e.target.value)} className="w-full border border-gray-300 bg-white rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-blue-500 outline-none appearance-none font-medium">
